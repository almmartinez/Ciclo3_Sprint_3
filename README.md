...
2. Locate the line `INSERT INTO credentials (name,user,password) VALUES ('EMAIL_APP','alexandermm@uninorte.edu.co', '$TR41NC0URS3R4$')`.
3. Replace `alexandermm@uninorte.edu.co` with the email address.
